...
(11) DEFAULT NULL,
  `diagnosistypeid` int
(11) NOT NULL,
  `diagnoses_obj_id` int
(11) DEFAULT NULL,
  `diagnoses_ass_id` int
(11) DEFAULT NULL,
  `planid` int
(11) DEFAULT NULL,
...
(`patientid`),
  KEY `objectiveid_idx`
(`diagnoses_obj_id`),
  KEY `assessmentid_idx`
(`diagnoses_ass_id`),
  KEY `planid_idx`
(`planid`),
  CONSTRAINT `diabetic_shoe_id` FOREIGN KEY
(`id`) REFERENCES `diabetic_shoe`
(`id`) ON
DELETE NO ACTION ON
UPDATE NO ACTION,
  CONSTRAINT `diagnoses_ass_id` FOREIGN KEY
(`diagnoses_ass_id`) REFERENCES `diagnoses_assessment`
(`diagnoses_id`) ON
DELETE NO ACTION ON
UPDATE NO ACTION,
  CONSTRAINT `diagnoses_obj_id` FOREIGN KEY
(`diagnoses_obj_id`) REFERENCES `diagnoses_objectives`
(`diagnoses_id`) ON
DELETE NO ACTION ON
UPDATE NO ACTION,
  CONSTRAINT `diagnosistypeid` FOREIGN KEY
(`diagnosistypeid`) REFERENCES `diagnosistype`
(`id`) ON
DELETE NO ACTION ON
UPDATE NO ACTION,
  CONSTRAINT `orthotic_type_id` FOREIGN KEY
(`id`) REFERENCES `orthotic_type`
(`id`) ON
DELETE NO ACTION ON
UPDATE NO ACTION,
  CONSTRAINT `patientid` FOREIGN KEY
(`patientid`) REFERENCES `patientinfo`
(`id`) ON
DELETE NO ACTION ON
UPDATE NO ACTION,
  CONSTRAINT `planid` FOREIGN KEY
(`planid`) REFERENCES `plan`
(`id`) ON
DELETE NO ACTION ON
UPDATE NO ACTION,
  CONSTRAINT `prosthetic_type_id` FOREIGN KEY
(`id`) REFERENCES `prosthetic_type`
(`id`) ON
DELETE NO ACTION ON
UPDATE NO ACTION
) ENGINE=InnoDB
AUTO_INCREMENT=29 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
diagnoses`
VALUES
    (7, 5, 3, NULL, NULL, 5, 7, 7, 1, '2020-07-31 14:35:26'),
    (9, 7, 3, NULL, NULL, 2, NULL, NULL, 5, '2020-07-31 14:42:03'),
    (10, 7, NULL, 1, NULL, 1, 10, NULL, 1, '2020-07-31 14:44:04'),
    (11, 8, 3, NULL, NULL, 4, NULL, NULL, 1, '2020-07-31 14:58:39'),
    (12, 2, 2, NULL, NULL, 4, NULL, NULL, 1, '2020-07-31 15:01:14'),
    (20, 2, 2, NULL, NULL, 1, NULL, NULL, 2, '2020-08-03 16:26:45'),
    (21, 3, 2, NULL, NULL, 5, 21, 21, 1, '2020-08-03 16:35:25'),
    (22, 4, NULL, 2, NULL, 1, 22, 22, 2, '2020-08-03 16:40:13'),
    (23, 6, 3, NULL, NULL, 5, 23, 23, 1, '2020-08-03 16:59:42'),
    (24, 9, NULL, NULL, 1, 1, 24, 24, 1, '2020-08-03 17:02:42'),
    (25, 10, NULL, NULL, 3, 4, NULL, NULL, 1, '2020-08-03 17:12:46'),
    (26, 10, NULL, 1, NULL, 3, 26, 26, 1, '2020-08-03 17:16:55'),
    (27, 11, 2, NULL, NULL, 1, 27, 27, 2, '2020-08-03 17:23:34'),
    (28, 11, 2, NULL, NULL, 4, NULL, NULL, 1, '2020-08-03 17:27:22');
...
(11) NOT NULL,
  PRIMARY KEY
(`diagnoses_id`,`assessment_id`),
  KEY `assessment_id_idx`
(`assessment_id`),
  CONSTRAINT `diagnoses_ass_id#` FOREIGN KEY
(`assessment_id`) REFERENCES `assessment`
(`id`) ON
DELETE NO ACTION ON
UPDATE NO ACTION,
  CONSTRAINT `diagnoses_id#` FOREIGN KEY
(`diagnoses_id`) REFERENCES `diagnoses`
(`id`) ON
DELETE NO ACTION ON
UPDATE NO ACTION
) ENGINE=InnoDB
AUTO_INCREMENT=28 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
(11) NOT NULL,
  PRIMARY KEY
(`diagnoses_id`,`objectives_id`),
  KEY `diagnoses_id_idx`
(`diagnoses_id`,`objectives_id`),
  KEY `objective_id_idx`
(`objectives_id`),
  CONSTRAINT `diagnoses_id` FOREIGN KEY
(`diagnoses_id`) REFERENCES `diagnoses`
(`id`) ON
DELETE NO ACTION ON
UPDATE NO ACTION,
  CONSTRAINT `diagnoses_obj_id2` FOREIGN KEY
(`objectives_id`) REFERENCES `objective`
(`id`) ON
DELETE NO ACTION ON
UPDATE NO ACTION
) ENGINE=InnoDB
...
(45) NOT NULL,
  PRIMARY KEY
(`id`),
  UNIQUE KEY `objectivename_UNIQUE`
(`objectivename`)
...
patientinfo`
VALUES
    (2, 'Oscar Pistorius', '11/22/86', 'oscarp86@yahoo.com', '205-867-5309', '2020-07-29 16:29:53'),
    (3, 'Josh Hurn', '6/10/92', 'josh@innovatebham.com', '205-911-1119', '2020-07-29 16:34:47'),
    (4, 'Nancy Kerrigan', '10/13/69', 'NancyK69@gmail.com', '781-339-1992', '2020-07-29 16:52:18'),
    (5, 'Heather Mills', '1/12/68', 'hmills68@earthlink.net', '281-330-8004', '2020-07-29 17:00:54'),
    (6, 'Jim Abbott', '9/19/67', 'jabbott@milwauleebrewers.com', '810-671-8834', '2020-07-29 17:05:58'),
    (7,'Miles O\'brien','6/9/59','milesob@pbs.org','810-775-9954','2020-07-29 17:10:34'),(8,'Bethany Hamilton','2/8/90','soulsurfer@gmail.com','808-762-9003','2020-07-30 10:08:57'),(9,'Rick Allen','11/1/63','1armdrummer@def.leppard.com','310-314-5513','2020-07-30 10:12:31'),(10,'Frida Kahlo','7/6/07','vivalavida@yahoo.com','303-998-1191','2020-07-30 10:19:02'),(11,'Amy Purdy','11/7/79','onmyown2feet@paralympics.org','702-334-8655','2020-07-30
10:22:31');
